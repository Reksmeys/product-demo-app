...
import ba from './../assets/mine.jpeg'
          ...
          <div class="container">
            ...
            <div class="row g-4">
              ...
              <div class="col-10 text-center mx-auto position-relative">
                ...
                <h1 class="position-relative fs-2">ISTAD has routed Cambodian students to advanced science and technology, research, and develop digital skills and our graduates have been guaranteed excellent job opportunities with the Top IT company.</h1>
              </div>
              ...
              <div class="col-6 col-md-4">
                <div class="row g-4">
                  ...
                  <div class="col-10 col-lg-6">
                    <img class="rounded-4" src={me} alt="" />
                  </div>
                
                  <div class="col-12">
                    <img class="rounded-4" src={ba} alt="" />
                  </div>
                </div>
              </div>
                ...
                <div class="row g-4">
                  ...
                  <div class="col-sm-6 col-md-12">
                    <div class="bg-grad rounded-4 p-5 text-start">
                      ...
                      <h3 class="text-white">“Sharing is my happiness 👩🏻‍💻”</h3>
                      <span class="text-white">Ms. Mom Reksmey</span>
                    </div>
                  </div>
